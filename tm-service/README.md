...
```
cd existing_repo
git remote add origin https://gitlab.pcss.pl/bluebird/trading-module.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.pcss.pl/bluebird/trading-module/-/settings/integrations)
