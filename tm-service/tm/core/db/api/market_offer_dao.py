...
class MarketOfferAPI(DAO):
    ...
    @abstractmethod
    def list_offer_info(self, ts: Optional[TimeSpan], market_id: Optional[int] = None, isp_unit: Optional[int] = None,
                        sequence: Optional[str] = None) -> List[EnergyMarketOfferInfo]:
        pass
